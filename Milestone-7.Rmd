...
The next page displays a series of graph that is part of a series of ten graphs that show up as one graphic (Figure 2) in the article. Lazarev created a function that grouped them all together into one graphic; however, this function did not work as planned for me, so I split it up into 3 separate graphics using the ggarrange() function in the ggpubr package.
```{r include = FALSE}
