...
First, I show the Bayesian regression equivalent for the figure that Lazarev labels as Table 2 in his data. I ran stan_glm() on the same variables that Lazarev included, and put the resulting coefficients and error measurements into a gt table for easy readibility.  
