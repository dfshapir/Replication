...
The next page displays a series of graphs that show up as Figure 2 in the article. Lazarev created a function that grouped them all together into one graphic; however, this function did not work as planned for me, so I used the ggarrange() function in the ggpubr package instead.
```{r include = FALSE}
