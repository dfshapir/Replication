...
First, I show the Bayesian regression equivalent for the figure that Lazarev labels as Table 2 in his data. This table measures how various variables are likely to effect a person's likelihood of choosing Russian Law, Sharia, or Adat. In his paper, Lazarev argues that woman are much more likely to choose Russian law organs than men. Lazarev also includes various other independent variables, in addition to "female," in his regression, which I have included in the Bayesian regression as  well. The dependent variables are Lazarev's respective "indexes." I ran stan_glm() on the same variables that Lazarev included, and put the resulting coefficients and error measurements into a gt table for easy readibility.  
